...
//Retreiving all the the players per country click
// var worldCupPlayers = {

//   playerURL: "http://worldcup.kimonolabs.com/api/players?apikey=f0rt5uSfHOFwGCbA18wh48xRUFbCtr81",
//   // sort: $('.name').text(),
//   // playerOption: {
//   //   nationality: this.sort
//   // },

//   toShowPlayers: function(data){
//     console.log(data);
...
//   players: function(){
//     $('button').onclick(this.showPlayers.bind(worldCupPlayers));
...
//     e.preventDefault();
//     $.getJSON(this.playerURL, this.toShowPlayers).fail(function(){
//       var repo ='<p>'+"User Repo not found"+'</p>';
//       $('#view').html(repo);
//     });
//   }
...
//To retrive  players per country
//$(document).ready(function(){
